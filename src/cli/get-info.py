...
def fetch_hierarchical_data_from_graphdb(graphdb_endpoint_url, graph_uri, limit=10000, offset=0):
...
def get_hierarchical_data_from_graphdb(graphdb_endpoint_url, graph_uri):
    ...
    while True:
        ...
        results_csv = fetch_hierarchical_data_from_graphdb(graphdb_endpoint_url, graph_uri, limit=batch_size, offset=offset)
